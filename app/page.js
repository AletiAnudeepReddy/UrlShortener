      ...
      <section className="grid grid-cols-2 h-[50vh]">
        <div className="flex flex-col items-center gap-4 justify-center">
          ...
          <div className='flex gap-3 justify-start items-center'>
            <Link href="/generate"><button className='text-white hover:bg-purple-400 hover:h-9 bg-purple-500 rounded-lg shadow-lg p-3 py-1 font-bold'>Try Now</button></Link>
            <Link href="/generate"><button className='text-white hover:bg-purple-400 hover:h-9 bg-purple-500 rounded-lg shadow-lg p-3 py-1 font-bold'>Github</button></Link>
          </div>
        </div>
