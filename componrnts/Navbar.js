  ...
  return (
    <nav className='h-16 bg-purple-700 flex justify-between px-5 items-center text-white'>
        <div className='logo font-bold text-2xl'>
            <Link className='hover:transition-all hover:font-bold' href="/">BitLinks</Link>
        </div>
        <ul className='flex justify-center gap-4 items-center'>
            ...
            <Link className='hover:transition-all hover:font-bold' href="/shorten"><li>Shorten</li></Link>
